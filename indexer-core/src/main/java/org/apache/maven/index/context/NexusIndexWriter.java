    ...
    extends IndexWriter
{
        ...
        throws CorruptIndexException, LockObtainFailedException, IOException
    {
        ...
        this(directory, new IndexWriterConfig(Version.LUCENE_43, analyzer));
    ...
    {
        final IndexWriterConfig config = new IndexWriterConfig( Version.LUCENE_43, new NexusAnalyzer() );
